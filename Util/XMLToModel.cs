...
namespace Util
{
  public static  class XMLToModel
    {
        public static object XMLToModelT(string xml, object SampleModel)
        {
            ...
            else
            {
                ...
                XmlNodeList attributes = xmldoc.SelectSingleNode("OutputParameter").ChildNodes;
        ...
        public static object XMLToModelTo(string xml, object SampleModel)
        {
            if (string.IsNullOrEmpty(xml))
                return SampleModel;
            else
            {
                ...
                XmlNodeList attributes = xmldoc.SelectSingleNode("ROW").ChildNodes;
                foreach (XmlNode node in attributes)
                {
                    foreach (PropertyInfo property in SampleModel.GetType().GetProperties())
                    {
        ...
        {
            XmlDocument xmldoc = new XmlDocument();
            XmlElement ModelNode = xmldoc.CreateElement("OutputParameter");
