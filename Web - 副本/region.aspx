                ...
                <div class="personal_table_box">
                    ...
                    <input class="int_rad" id="Radio1" name="sex1" type="radio" value="2" />女士</td>
                      ...
                      <input type="text" name="USER_AGE" id="USER_AGE" readonly="true" class="txt" placeholder="请填写出生日期" runat="server" />
                        ...
                        <tr>
                            <td class="bgwhite padleft">验证码<input type="text" id="password" name="password" class="txt" placeholder="短信验证码" runat="server" />
                                <span style="float: right">
                                    <input type="button" id="btn" value="免费获取验证码" onclick="settime(this)" style="color: #000000; border: solid #000000 1.5px; background-color: transparent;" />
                                </span>
                        ...
                        <tr>
                            <td>
                                <input name="" type="checkbox" value="" style="vertical-align: middle; margin-top: 0;" />
...
（5）	用户在HAPSODE悦芙媞官网，在未经网站的事先书面允许，禁止用户在网站上发布任何形式的
       广告，不得从事利用网站信息的营业活动，对该等营业活动的后果网站不承担责任。且用户因该等营业活动导致网站损失的，用户应承担赔偿责任，网站对该等用户可采取限制使用服务等合法措施。
                        ...
                        <p>第五条 以上会员注册条例的最终解释权归悦芙媞（杭州）化妆品有限公司所有。
</p>
                    ...
                    <div class="link-area">
                        <a id='reg' style="color: #4b8e63;">绑定/登录会员</a>
                    </div>
