                ...
                <div class="private_wrap">
                    ...
                    <div class="log_info">
                        <div class="profile_txt">
                            ...
                            <div id="bcTarget" style="margin: 0px; padding: 0;width: 100%; text-align: center;margin-left: auto;
margin-right: auto;"></div>

                            <div style="text-align: center; margin: 0; padding: 0;">
                                <input id="src" value="1570008562612" style="border-style: none; border-color: inherit; border-width: 0px; background-color: transparent; width: 124px;" /></div>
                ...
                <div class="tab1" id="tab1">
                    <div class="menu">
                        <ul>
                            ...
                            <li id="one1" onclick="setTab('one',1)"><img style="width: 40px; height:40px;" src="images/积分-01.png" />(0)</li>
                            <li id="one2" onclick="setTab('one',2)"><img style="width: 40px; height:40px;" src="images/优惠券-01.png" />(0张)</li>
